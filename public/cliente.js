document.addEventListener('DOMContentLoaded', () => {
    ...
    function dragDrop() {
        let shipNameWithLastId = isHorizontal? draggedShip.lastElementChild.id :draggedShip.firstElementChild.id 
        ...
        let restaAjuste = selectedShipIndex * (width-1);
        // console.log(shipLastId)
        ...
        if (isHorizontal && !newNotAllowedHorizontal.includes(shipLastId)) {
            ...
            for (let i = 0; i < draggedShipLength; i++) {
                ...
                if (i === 0) directionClass = 'start'
                if (i === draggedShipLength - 1) directionClass = 'end'
                userSquares[parseInt(this.dataset.id) - selectedShipIndex - restaAjuste + width * i].classList.add('taken', 'vertical', directionClass, shipClass)
            }
        } else return
